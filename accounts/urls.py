...
urlpatterns = [
    ...
    path("organizations/<slug:organization_slug>/departments/", OrganizationDepartmentView.as_view(), name="organization-departments"),
